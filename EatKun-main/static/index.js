...
function shareText(score) {
    ...
    SubmitResults();
    if (score <= 30) return 'WatchPaper太美(bushi';
    if (score <= 60) return 'WatchPaper你叔叔美';
    if (score <= 100) return '叔叔叔叔叔';
    if (score <= 150) return 'J·K·罗琳与JK萝莉，不愧是叔叔！！！';
    return '你就是WatchPaper本人？';
}
